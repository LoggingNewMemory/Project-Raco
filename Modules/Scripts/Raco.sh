...
performance_basic() {
    ...
    # 12. Block Read Ahead (Concurrent Loop)
    ...
    wait # Wait for all general tweaks to finish
...
balanced_basic() {
    ...
    # 2. Kernel/VM/Sched Tweaks Parallel Group
    (
